...
const SuperHero =()=>{
    ...
    return (
      <>
        <header className="flex flex-col text-white min-h-screen bg-[url('https://c4.wallpaperflare.com/wallpaper/67/283/725/night-lights-in-dubai-wallpaper-preview.jpg')] bg-center bg-no-repeat bg-cover bg-indigo-700 bg-blend-multiply">
            ...
            <div className=" pt-6">
              ...
              >
                  ...
                  <div className="hidden space-x-8 md:ml-10 md:flex">
                    {navigation.map((item) => (
                      <a
                        key={item.name}
                        href={item.href}
                        className="text-base font-medium text-indigo-300 hover:text-indigo-100"
                      >
                        {item.name}
                      </a>
                    ))}
                ...
                <div className="hidden md:flex md:items-center md:space-x-6">
                  <a
                    href="#"
                    className=" flex md:items-center text-base font-medium text-white hover:text-gray-300"
                  >
                    hello
                  </a>
                  ...
                  >
                    <PhoneIcon className="h-6 w-6 border-r pr-2" />
                    <span className="pl-2">+971 00 00 0000</span>
                  </a>
                </div>
              </nav>
            </div>
